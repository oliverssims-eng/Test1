...
(function () {
  ...
  CL.bLunge = S.clip({ // perilous skewer — coil low, then a missile
    ...
    keys: [
      ...
      [0.55, { shR: [-0.15, 0, -0.4], elR: [-1.35, 0, 0], wrR: [-0.45, 0, 0],
               shL: [-0.9, 0, 0.45], elL: [-1.25, 0, 0],
               chest: [-0.08, 0.7, 0], spine: [-0.05, 0.32, 0], neck: [0.08, -0.4, 0],
               kneeL: [0.55, 0, 0], kneeR: [0.55, 0, 0], hipL: [-0.35, 0, 0.05], hipR: [-0.35, 0, -0.05],
               y: -0.2 }, 'inout'],
      [0.9, { shR: [-0.1, 0, -0.45], y: -0.24 }],
      [1.05, { shR: [-1.55, 0, 0.02], elR: [0, 0, 0], wrR: [-0.12, 0, 0],
               shL: [-0.25, 0, 0.75], elL: [-0.35, 0, 0],
               chest: [0.32, -0.35, 0], spine: [0.25, -0.18, 0], neck: [-0.28, 0.18, 0],
               hipR: [-0.6, 0, -0.04], hipL: [0.4, 0, 0.04], kneeL: [0.7, 0, 0],
               y: -0.16 }, 'snap'],
      [1.25, { shR: [-1.6, 0, 0.02], chest: [0.34, -0.38, 0] }],
  ...
  CL.bLeap = S.clip({ // vaulting spear slam
    ...
    keys: [
      ...
      [0.4, { kneeL: [0.7, 0, 0], kneeR: [0.7, 0, 0], hipL: [-0.5, 0, 0.05], hipR: [-0.5, 0, -0.05],
              ...
              y: -0.26 }, 'inout'],
      [0.72, { shR: [-2.9, 0, -0.3], elR: [-0.4, 0, 0], wrR: [-0.3, 0, 0],
               shL: [-1.4, 0, 0.5], elL: [-0.8, 0, 0],
               chest: [-0.2, 0, 0], spine: [-0.12, 0, 0], neck: [0.2, 0, 0],
               hipL: [-0.9, 0, 0.05], kneeL: [1.3, 0, 0], hipR: [-0.35, 0, -0.05], kneeR: [0.7, 0, 0],
               y: 0.85 }, 'out'],
      [1.0, { shR: [-0.6, 0, -0.1], elR: [-0.1, 0, 0], wrR: [-1.3, 0, 0],
              shL: [0.35, 0, 0.4], elL: [-0.3, 0, 0],
              chest: [0.52, 0, 0], spine: [0.36, 0, 0], neck: [-0.35, 0, 0],
